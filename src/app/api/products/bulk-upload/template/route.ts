...
export async function GET(request: NextRequest) {
  try {
    ...
    const productData = [
      ['NAMA PRODUK*', 'SKU', 'BARCODE', 'HPP (Rp)', 'HARGA JUAL* (Rp)', 'QTY / STOK', 'SATUAN', 'KATEGORI', 'PUNYA VARIAN', 'PUNYA KOMPOSISI', 'IMAGE URL'],
      // ── F&B: Makanan & Minuman ──
      ...
      ['Ayam Geprek', 'SKU-003', 'SKU-003', 12000, 20000, 30, 'porsi', 'Makanan', 'tidak', 'tidak', 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400'],
      ...
      ['Jus Alpukat', 'SKU-007', 'SKU-007', 6000, 15000, 30, 'gelas', 'Minuman', 'tidak', 'tidak', 'https://images.unsplash.com/photo-1546173159-315724a31696?w=400'],
    ...
    const guideData = [
      ...
      ['IMAGE URL', 'URL gambar produk (harus diawali http:// atau https://). Kosongkan jika tidak ada.', 'https://example.com/produk.jpg', 'Tidak'],
      [''],
      ...
      ['• Image URL yang tidak valid akan menyebabkan baris tersebut dilewati (skip)'],
    ]
